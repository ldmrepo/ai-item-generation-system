    ...
    seed_items: {
        ...
        "FUN-008": [
            ...
            },
            {
                ...
                answer: "(x, y) = (2, 3)",
                explanation:
                    "첫 번째 방정식 2x + y = 7을 y에 대해 정리하면 y = -2x + 7이다. 두 번째 방정식 x - y = 1을 y에 대해 정리하면 y = x - 1이다. 이 두 일차함수의 그래프를 좌표평면 위에 그리면, 두 직선의 교점의 좌표가 연립방정식의 해가 된다. -2x + 7 = x - 1을 풀면, -2x - x = -7 - 1, -3x = -8, x = 8/3이다. 이 값을 y = x - 1에 대입하면 y = 8/3 - 1 = 5/3이다. 따라서 해는 (8/3, 5/3)이다.",
