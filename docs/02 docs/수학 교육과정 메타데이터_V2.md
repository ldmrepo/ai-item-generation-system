...
| **노드 타입**          | **설명**            | **속성**                                                                                                                                                                                                          |
| ---------------------- | ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Curriculum**         | 교육과정 정보       | `id`: 교육과정 식별자<br>`name`: 교육과정 이름<br>`year`: 개정 연도<br>`description`: 교육과정 설명<br>`goals`: 교육과정 목표<br>`human_vision`: 교육과정이 지향하는 인간상<br>`basic_literacies`: 기초 소양 목록 |
...
| **GeneralCompetency**  | 총론 핵심역량       | `id`: 역량 식별자<br>`name`: 역량 이름<br>`description`: 역량 설명                                                                                                                                                |
| **BasicLiteracy**      | 기초 소양           | `id`: 소양 식별자<br>`name`: 소양 이름<br>`description`: 소양 설명                                                                                                                                                |
| **CourseStructure**    | 고등학교 과목 구조  | `id`: 과목 구조 식별자<br>`name`: 구조 이름(공통/일반선택/진로선택/융합선택)<br>`description`: 과목 구조 설명                                                                                                     |
| **EducationalElement** | 교수·학습 환경 요소 | `id`: 요소 식별자<br>`name`: 요소 이름<br>`description`: 요소 설명                                                                                                                                                |
...
| **HAS_COMPETENCY**            | Curriculum      | GeneralCompetency  | 교육과정이 총론 핵심역량을 포함          | 없음                                         |
| **RELATES_TO**                | Competency      | GeneralCompetency  | 교과 역량이 총론 핵심역량과 연계         | `strength`: String (연계 강도)               |
| **DEVELOPS**                  | Competency      | BasicLiteracy      | 교과 역량이 기초 소양을 개발             | `level`: String (개발 수준)                  |
| **HAS_STRUCTURE**             | Curriculum      | CourseStructure    | 교육과정이 과목 구조를 포함              | 없음                                         |
| **EMPHASIZES**                | Curriculum      | EducationalElement | 교육과정이 교수·학습 환경 요소를 강조    | `priority`: Integer (우선순위)               |
